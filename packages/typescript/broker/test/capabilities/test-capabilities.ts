...
try {
  ...
  //   doctor.ts family.agent === 'pi'  the bridge-ownership overlay picks which family's receipt and
  //                                    file-safety evidence (pi vs omp) replaces the adapter's bridge
  //                                    content check. It changes doctor presentation and remediation,
  //                                    not an agent capability answer.
