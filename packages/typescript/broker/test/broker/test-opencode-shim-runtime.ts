 ...
 * (packages/typescript/adapters/opencode/assets/opencode-shim.sh).
 *
 ...
 *
 *   bun run packages/typescript/broker/test/broker/test-opencode-shim-runtime.ts
 */
export {};
...
const SHIM = join(import.meta.dir, '../../../adapters/opencode/assets/opencode-shim.sh');
const REBUILD_RESTART = join(import.meta.dir, '../../../../../scripts/dev/rebuild-restart-app.sh');
const UI_DRIVE = join(import.meta.dir, '../../../../../scripts/dev/ui-drive.mjs');
