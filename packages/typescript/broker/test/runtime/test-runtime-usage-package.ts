 ...
 *
 *   bun run packages/typescript/broker/test/runtime/test-runtime-usage-package.ts
 */
export {};
...
const steps: Step[] = [
  ...
  },
  {
    ...
    cmd: [bun, 'run', 'packages/typescript/broker/test/claude/test-claude-runtime.ts'],
  },
  {
  ...
  },
  {
    ...
    cmd: [bun, 'run', 'packages/typescript/broker/test/codex/rollout.ts'],
  },
  {
    name: 'Codex app-server runtime mapping',
    cmd: [bun, 'run', 'packages/typescript/broker/test/codex/resume-fake.ts'],
  },
  {
    name: 'Pi observe runtime mapping',
    cmd: [bun, 'run', 'packages/typescript/adapters/pi/test/test-pi-observe.ts'],
  },
  {
    name: 'Pi bridge runtime wire',
    cmd: [bun, 'run', 'packages/typescript/broker/test/pi/test-tool-result-enrich.ts'],
  },
  {
    name: 'OpenCode private Observe/Drive runtime mapping',
    cmd: [bun, 'run', 'packages/typescript/adapters/opencode/test/test-opencode-private.ts'],
  },
];
