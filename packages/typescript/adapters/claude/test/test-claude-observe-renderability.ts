 ...
 *
 *   bun run packages/typescript/adapters/claude/test/test-claude-observe-renderability.ts   (exit 0 = all pass)
 */
export {};
...
import { mapTranscript, ClaudeObserveConnection } from '../src/index.ts';
