 ...
 *
 *   bun run packages/typescript/adapters/claude/test/test-claude-tasks.ts   (exit 0 = all pass)
 */
export {};
import { mkdirSync, writeFileSync } from 'node:fs';
import { join } from 'node:path';
import { ClaudeResumeConnection, ClaudeTaskLedger, mapTranscript, type ClaudeStore } from '../src/index.ts';
