...
class PasteboardPlatformWeb implements PasteboardPlatform {
  ...
  @override
  Future<List<String>> files({int? limit}) async => const [];

  /// The browser never reaches this adapter: web intake claims files from the
  /// paste/drop event itself, which is already bounded at the event boundary.
  @override
