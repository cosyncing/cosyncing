...
class FlutterLocalNotificationsWindows extends WindowsNotificationsBase {
  ...
  @override
  WindowsNotificationSetting? notificationSetting() {
    if (!_isReady) {
      return null;
    }
    final int value = _bindings.getNotificationSetting(_plugin);
    return value < 0 || value >= WindowsNotificationSetting.values.length
        ? null
        : WindowsNotificationSetting.values[value];
  }
