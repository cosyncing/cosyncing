...
class NotificationsPluginBindings {
  ...
  /// cosyncing: `ToastNotifier.Setting`, or -1 when unavailable.
  int getNotificationSetting(ffi.Pointer<NativePlugin> plugin) {
    return _getNotificationSetting(plugin);
  }

  late final _getNotificationSettingPtr =
      _lookup<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<NativePlugin>)>>(
        'getNotificationSetting',
      );
  late final _getNotificationSetting = _getNotificationSettingPtr
      .asFunction<int Function(ffi.Pointer<NativePlugin>)>();
}
