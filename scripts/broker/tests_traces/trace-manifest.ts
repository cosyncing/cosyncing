...
export const TRACE_MANIFEST: TraceManifestEntry[] = [
  {
    ...
    coverage: [
      { fn: 'F08', level: 'D', agents: 'all', note: 'model and mode drift where live probes are available' },
      { fn: 'F09', level: 'D', agents: 'all', note: 'command registry drift for registered adapters' },
