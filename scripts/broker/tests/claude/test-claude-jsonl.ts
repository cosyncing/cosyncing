 ...
 *
 *   bun run scripts/broker/tests/claude/test-claude-jsonl.ts      (exit 0 = all pass)
 */
export {};
import { writeFileSync, appendFileSync, mkdtempSync, mkdirSync } from 'node:fs';
import { tmpdir } from 'node:os';
import { join } from 'node:path';
import { CANONICAL_MESSAGE_TYPES, summarizeDiff } from '../../../../packages/typescript/adapter-api/src/index.ts';
import { ClaudeAdapter, ClaudeObserveConnection, ClaudeResumeConnection, mapTranscript, enrichClaudeToolResult, structuredPatchToDiff } from '../../../../packages/typescript/adapters/claude/src/index.ts';
import type { ClaudeStore } from '../../../../packages/typescript/adapters/claude/src/index.ts';
import type { AgentMessage, SessionInfo } from '../../../../packages/typescript/adapter-api/src/index.ts';
