 ...
 *
 *   bun run scripts/broker/tests/claude/test-claude-drive-surface.ts   (exit 0 = all pass)
 */
export {};
import { mkdtempSync, rmSync, existsSync, readFileSync, writeFileSync, mkdirSync } from 'node:fs';
import { tmpdir } from 'node:os';
import { join } from 'node:path';
import { ClaudeResumeConnection } from '../../../../packages/typescript/adapters/claude/src/index.ts';
