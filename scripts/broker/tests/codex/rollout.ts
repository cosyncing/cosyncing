 ...
 *
 *   bun run scripts/broker/tests/codex/rollout.ts     (exit 0 = all pass)
 */
export {};
...
import { historySourceStillContainsSnapshot } from '../../../../packages/typescript/broker/src/history-page-cache.ts';
import type { AgentMessage, HistorySnapshotSink } from '../../../../packages/typescript/adapter-api/src/index.ts';
import { CANONICAL_MESSAGE_TYPES, isHistorySnapshotRefusal, isOwnershipConflictError } from '../../../../packages/typescript/adapter-api/src/index.ts';
...
import { CodexAdapter, captureFileHistoryInto, codexAttachMode, inferRolloutStatus, inferRolloutStatusResult, codexSessionOrigin, mapRollout } from '../../../../packages/typescript/adapters/codex/src/index.ts';
...
await (async () => {
  ...
  try {
    ...
    writeFileSync(
      probe,
      `import { CodexAdapter } from ${JSON.stringify(join(import.meta.dir, '../../../../packages/typescript/adapters/codex/src/index.ts'))};\n` +
