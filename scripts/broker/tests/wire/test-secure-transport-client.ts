...
import { generateDataKey, generateIdentityKeyPair } from '../../../../packages/typescript/crypto/src/index.ts';
import { MemoryRelay, TailscaleDirectTransport } from '../../../../packages/typescript/transport/src/index.ts';
import {
