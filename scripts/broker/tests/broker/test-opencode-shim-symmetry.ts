...
import { KNOWN_INSTALL_RESOURCE_IDS } from '../../../../packages/typescript/broker/src/install-resource-ids.ts';
import { AGENT_SKILL_RESOURCE_IDS, agentSkillTargets } from '../../../../packages/typescript/broker/src/agent-skill.ts';
import { TAILSCALE_SERVE_RESOURCE_ID } from '../../../../packages/typescript/broker/src/tailscale-serve.ts';
import {
...
import { readSetupState, writeSetupState } from '../../../../packages/typescript/broker/src/setup-state.ts';
