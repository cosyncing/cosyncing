...
} from '../../../../packages/typescript/broker/src/setup-actions.ts';
import {
  buildSetupPlan,
...
} from '../../../../packages/typescript/broker/src/setup-presenter.ts';
import { CLAUDE_MINIMUM_VERSION } from '../../../../packages/typescript/adapters/claude/src/diagnostics.ts';
import {
...
} from '../../../../packages/typescript/broker/src/tokdash-provision.ts';
import {
  resolveTokdashEndpoint,
  tokdashRejectionReason,
  TOKDASH_DEFAULT_BASE_URL,
} from '../../../../packages/typescript/broker/src/tokdash-quota.ts';
import {
  normalizeSetupLanguage,
  setupMessages,
  type SetupLanguage,
  type SetupMutationStep,
} from '../../../../packages/typescript/broker/src/setup-i18n.ts';
import {
  agentSkillTargets,
  AGENT_SKILL_SHA256,
  AGENT_SKILL_SOURCE,
...
try {
  ...
  // Repair must refuse to run against a pending setup transaction rather than reporting a clean machine.
  {
    ...
    const { inspectRepair, runRepair } = await import('../../../../packages/typescript/broker/src/broker-lifecycle.ts');
    const repairOptions = {
      home,
      buildInfo: BUILD_INFO,
      executablePath: join(machine, 'bin', 'cosyncing'),
