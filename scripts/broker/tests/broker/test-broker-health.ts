...
type HealthModule = typeof import('../../../../packages/typescript/broker/src/broker-health.ts');

function assert(condition: unknown, message: string): asserts condition {
  if (!condition) throw new Error(message);
}

const health = await import('../../../../packages/typescript/broker/src/broker-health.ts').catch((error: unknown) => {
