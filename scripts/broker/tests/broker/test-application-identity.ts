...
import { inspectInstalledBinary } from '../../../../packages/typescript/broker/src/setup-actions.ts';
import { installedBinaryPath } from '../../../../packages/typescript/broker/src/install-state.ts';
