 ...
 *
 * Run: bun run scripts/broker/tests/broker/test-diff-body-reference.ts
 */
...
import { buildDiffRefMessage, HARD_MAX_REFERENCED_DIFF_BYTES, MAX_REFERENCED_DIFF_BYTES } from '../../../../packages/typescript/broker/src/diff-reference.ts';
import {
...
async function main() {
  ...
  try {
    ...
    const probe = Bun.spawnSync(
      ['bun', '-e', "import {MAX_REFERENCED_DIFF_BYTES as m, HARD_MAX_REFERENCED_DIFF_BYTES as h} from './packages/typescript/broker/src/diff-reference.ts'; console.log(JSON.stringify({m, h}))"],
    ...
    const inlineProbe = Bun.spawnSync(
      ['bun', '-e', "import {INLINE_DIFF_CAP as c, HARD_MAX_REFERENCED_DIFF_BYTES as h} from './packages/typescript/broker/src/diff-reference.ts'; console.log(JSON.stringify({c, h}))"],
