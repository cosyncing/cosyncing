 ...
 *
 *   bun run scripts/broker/tests/broker/test-opencode-serve-restart-guardrail.ts
 */
export {};
import { mkdirSync, mkdtempSync, readFileSync, rmSync, utimesSync, writeFileSync } from 'node:fs';
import { tmpdir } from 'node:os';
import { join } from 'node:path';
import { evaluateConfigRestart, newestConfigMtime } from '../../../../packages/typescript/broker/src/opencode-serve.ts';
...
{
  const script = readFileSync(join(import.meta.dir, '../../../dev/rebuild-restart-app.sh'), 'utf8');
