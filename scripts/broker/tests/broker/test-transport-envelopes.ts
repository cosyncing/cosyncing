...
import { TailscaleDirectTransport } from '../../../../packages/typescript/transport/src/index.ts';
import { openTransportEnvelope, sealTransportEnvelope } from '../../../../packages/typescript/transport-wire/src/index.ts';
...
await test('pairing accept failure limiter is memory-bounded under unique-id spam', async () => {
  ...
  const { TransportPairingRegistry, PairingHttpError } = await import('../../../../packages/typescript/broker/src/transport-pairing.ts');
