...
import { AgentRegistry, type AgentMessage, type AgentMessageHandler, type SessionConnection, type SessionInfo } from '../../../../packages/typescript/adapter-api/src/index.ts';
