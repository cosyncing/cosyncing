 ...
 *
 *   bun run scripts/broker/tests/pi/test-tool-result-enrich.ts      (exit 0 = all pass)
 */
export {};
import { mkdtempSync, rmSync } from 'node:fs';
import { tmpdir } from 'node:os';
import { join, resolve } from 'node:path';
import { summarizeDiff, splitUnifiedDiffFiles } from '../../../../packages/typescript/adapter-api/src/index.ts';
import { enrichPiToolResult, piToolDisplayClass } from '../../../../packages/typescript/adapters/pi/src/index.ts';
import { PiBridgeConnection, PiBridgeRegistry } from '../../../../packages/typescript/broker/src/pi-bridge.ts';
import {
