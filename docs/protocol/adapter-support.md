...
| F13 agent-to-user artifacts | full: outbox plus SendUserFile mapping where present | full: outbox/app-server writes | partial: outbox works; native send_file strict mapping still guarded separately | full: outbox; native artifact support limited |
