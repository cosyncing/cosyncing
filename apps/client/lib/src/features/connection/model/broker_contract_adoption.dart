...
const Map<String, BrokerContractAdoption> brokerRouteAdoption = {
  ...
  // Deliberately not the same answer as the deferred `/api/tokdash/usage`
  // neighbour above. That refusal was about raw per-session usage with no
  // product surface; this route is an aggregated report DTO with a designed
  // one (Settings -> Usage overview), and prompt text is dropped broker-side
