...
void main() {
  test('audited Session primary surfaces do not render raw exceptions', () {
    const auditedFiles = <String, List<String>>{
      'lib/src/features/sessions/data/session_detail_controller.dart': [
        'clientError?.toString()',
        'error: e.toString()',
        r'Transcript could not be saved: $error',
        r'receipt could not be sent: $error',
      ],
      'lib/src/features/sessions/data/session_detail_request_coordinator.dart':
          [
            'state = state.copyWith(error: e.toString())',
          ],
      'lib/src/features/sessions/data/session_detail_messaging_coordinator.dart':
          [
            'state = state.copyWith(error: e.toString())',
            'state = state.copyWith(error: error.toString())',
            'historyPageError: error.toString()',
          ],
      'lib/src/features/sessions/data/session_detail_artifact_coordinator.dart':
          [
            'attachmentUploadMessage: e.toString()',
            '.markFailed(transferId, e.toString())',
          ],
      'lib/src/features/sessions/data/'
          'session_detail_session_action_coordinator.dart': [
        'error.error?.error ?? error.message',
        'message: error.toString()',
      ],
      'lib/src/features/sessions/data/session_file_browser.dart': [
        'message: e.toString()',
        'exception.error?.error ?? exception.message',
      ],
      'lib/src/features/sessions/data/session_artifact_transfer_worker.dart': [
        r'${error.runtimeType}',
        r'${e.runtimeType}',
        '_ => error.message',
      ],
      ...
      'lib/src/features/sessions/model/session_command_args_codec.dart': [
        'SessionCommandArgsParseResult.failure(error.toString())',
      ],
      'lib/src/features/sessions/view/'
      ...
      'lib/src/features/sessions/view/session_detail_page.dart': [
        'message: result.message',
        'SnackBar(content: Text(result.message))',
      ],
      'lib/src/features/sessions/view/session_artifact_preview_result.dart': [
